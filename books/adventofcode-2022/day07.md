...
まずは、この合計サイズが `100000` 以下のものを列挙しようとしています。該当するディレクトリの合計サイズをすべて足し合わせるといくつになるでしょうか、という問題。
...
あるディレクトリを丸ごと削除することで必要な空き容量を確保しようとしています。それを実現できる最小のディレクトリの合計サイズはいくつになるでしょうか、という問題。
